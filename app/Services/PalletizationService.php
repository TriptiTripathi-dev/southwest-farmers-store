...
class PalletizationService
{
    ...
    const MAX_PALLET_HEIGHT = 60; // inches
    ...
    {
        $maxWeight = self::MAX_PALLET_WEIGHT;
        $maxHeight = self::MAX_PALLET_HEIGHT;
        ...
        foreach ($items as $item) {
            ...
            // Weight per carton
            $cartonWeight = (($product->weight ?? 0) > 0 ? $product->weight : ($product->box_weight ?? 0)) * $unitsPerCarton;
