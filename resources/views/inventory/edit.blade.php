<x-app-layout title="Edit Product">
    <div class="container-fluid py-4">
        <div class="card shadow-sm col-md-8 mx-auto">
            ...
            <div class="card-body">
                <form action="{{ route('store.inventory.update', $stock->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mt-4">
                        ...
                        <a href="{{ route('store.inventory.index') }}" class="btn btn-secondary">Cancel</a>
                    </div>
                </form>
            </div>
        </div>
