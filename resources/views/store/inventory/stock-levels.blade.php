            ...
            <div class="modal-content border-0 shadow">
                ...
                <form id="editForm">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="min_stock" id="min_stock" class="form-control" required
                                min="0">
                            <div class="form-text">Auto-order will be created when quantity falls below this value.
                            </div>
                        </div>
                        <div class="mb-3">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary px-4 shadow-sm" id="saveBtn">Save
                            Changes</button>
                    </div>
                </form>
            </div>
            ...
            $(document).ready(function() {
                ...
                $('#editForm').on('submit', function(e) {
                    ...
                    $.ajax({
                        ...
                        error: function(err) {
                            let msg = err.responseJSON && err.responseJSON.message ? err
