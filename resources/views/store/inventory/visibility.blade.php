                    ...
                    <div class="card-body p-3">
                        ...
                        <div id="productSummary" class="mt-4 d-none">
                            <div class="text-center p-3 bg-light rounded-3">
                                <div id="productImg" class="mb-2 mx-auto rounded-circle border bg-white d-flex align-items-center justify-content-center" style="width: 80px; height: 80px; overflow: hidden;">
                                    ...
                                    <tr>
                                        <td colspan="4" class="text-center py-5">
                                            <div class="text-muted opacity-50">
                                                ...
                                                <p class="mb-0">Please select a product from the left to see inventory distribution.</p>
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
        ...
        function loadVisibility(id) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#summaryUPC').text('UPC: ' + (data.product.sku || 'N/A'));
