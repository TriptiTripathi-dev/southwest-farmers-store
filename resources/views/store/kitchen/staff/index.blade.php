<x-app-layout title="Kitchen Staff Scheduling &amp; Timesheets">
            ...
            <div class="row mb-4 g-3">
                <div class="col-md-3">
                    <div class="card border-0 shadow-sm rounded-4 border-start border-primary border-3">
                        <div class="card-body">
                            <p class="text-uppercase fw-medium text-muted mb-1 small">Scheduled Shifts</p>
                ...
                <div class="col-md-3">
                    <div class="card border-0 shadow-sm rounded-4 border-start border-success border-3">
                        <div class="card-body">
                            <p class="text-uppercase fw-medium text-muted mb-1 small">Currently Clocked In</p>
                ...
                <div class="col-md-3">
                    <div class="card border-0 shadow-sm rounded-4 border-start border-info border-3">
                        <div class="card-body">
                            <p class="text-uppercase fw-medium text-muted mb-1 small">Completed Shifts</p>
                ...
                <div class="col-md-3">
                    <div class="card border-0 shadow-sm rounded-4 border-start border-warning border-3">
                        <div class="card-body">
                            <p class="text-uppercase fw-medium text-muted mb-1 small">Hours Worked</p>
                                        ...
                                        <tr>
                                            ...
                                            <td class="pe-4 text-center">
                                                <div class="d-flex justify-content-center gap-1">
                                                    ...
                                                    <form action="{{ route('store.kitchen.staff.shift.destroy', $shift) }}" method="POST" onsubmit="return confirm('Are you sure you want to remove this shift?');">
                                                        @csrf
                                                        @method('DELETE')
                                                ...
                                                <div class="modal fade text-start" id="editShiftModal{{ $shift->id }}" tabindex="-1" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content">
                                                            <form action="{{ route('store.kitchen.staff.shift.update', $shift) }}" method="POST">
                                                                @csrf
                                                                @method('PUT')
                                ...
                                <table class="table table-hover align-middle mb-0">
                                    <thead class="bg-light">
                                        <tr>
                                            ...
                                            <th>Total Hours</th>
                                            <th class="text-center">Status</th>
                                            <th class="pe-4 text-center" style="width: 140px;">Action</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                {{ \Carbon\Carbon::parse($log->clock_in_at)->storeTime()->format('h:i:s A') }}
                                            </td>
                                            <td>
                                                @if($log->clock_out_at)
                                                    <i class="mdi mdi-clock-out text-danger me-1"></i>
                                                    {{ \Carbon\Carbon::parse($log->clock_out_at)->storeTime()->format('h:i:s A') }}
                                                @else
                                            ...
                                            <td class="pe-4 text-center">
                                                @if(!$log->clock_out_at)
                                                    ...
                                                    <div class="modal fade text-start" id="clockOutModal{{ $log->id }}" tabindex="-1" aria-hidden="true">
                                                        <div class="modal-dialog modal-dialog-centered">
                                                            <div class="modal-content">
                                                                <form action="{{ route('store.kitchen.staff.clock-out', $log) }}" method="POST">
                                                                    @csrf
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <p class="mb-3">
                                                                            Clock-in time recorded: <strong>{{ \Carbon\Carbon::parse($log->clock_in_at)->storeTime()->format('h:i A') }}</strong>
                                                                        </p>
                                                                        <div class="mb-3">
    ...
    <div class="modal fade" id="scheduleShiftModal" tabindex="-1" aria-labelledby="scheduleShiftLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <form action="{{ route('store.kitchen.staff.shift.store') }}" method="POST">
                    @csrf
    ...
    <div class="modal fade" id="clockInModal" tabindex="-1" aria-labelledby="clockInLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <form action="{{ route('store.kitchen.staff.clock-in') }}" method="POST">
                    @csrf
