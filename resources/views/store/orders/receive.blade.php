...
<div class="container-fluid">
    ...
    <form action="{{ route('store.orders.confirm-receive', $order->id) }}" method="POST" id="receiveForm" class="needs-validation" novalidate>
        @csrf
                                    ...
                                    @foreach($order->items as $index => $item)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <span class="badge bg-secondary bg-opacity-10 text-secondary">{{ $item->quantity }}</span>
                                            </td>
                                            <td class="text-center">
                                                <span class="badge bg-primary bg-opacity-10 text-primary">{{ $item->dispatched_quantity ?: $item->quantity }}</span>
                                            </td>
                                            <td>
