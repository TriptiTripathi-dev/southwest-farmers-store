        ...
        <div class="container-fluid px-3 px-md-4 py-4">
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-xl-10">
                    ...
                    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 gap-3">
                        <div class="d-flex align-items-center gap-3">
                            <a href="{{ route('store.products.index') }}"
                                ...
                                style="width: 40px; height: 40px;" title="Go Back">
                            ...
                            <div>
                                <h4 class="fw-bold mb-0 text-dark d-flex align-items-center">
                                    ...
                                    @if ($product->store_id)
                                        <span
                                            class="badge bg-warning bg-opacity-10 text-warning border border-warning border-opacity-25 ms-3 fs-6 rounded-pill px-3 py-1">
                                            <i class="mdi mdi-storefront me-1"></i> Local Product
                                        </span>
                                    @else
                                        <span
                                            class="badge bg-info bg-opacity-10 text-info border border-info border-opacity-25 ms-3 fs-6 rounded-pill px-3 py-1">
                    ...
                    @if (!$product->store_id)
                        <div
                            class="alert alert-warning bg-warning bg-opacity-10 border-warning border-opacity-25 text-dark rounded-4 mb-4 d-flex align-items-center p-3 shadow-sm">
                    ...
                    <form action="{{ route('store.products.update', $product->id) }}" method="POST"
                                ...
                                <div class="card border-0 shadow-sm rounded-4 h-100">
                                    <div class="card-header bg-white border-bottom p-4">
                                        <h6 class="mb-0 fw-bold text-dark"><i
                                                class="mdi mdi-tag-text-outline text-primary me-2"></i>Primary Details
                                        </h6>
                                    </div>
                                    <div class="card-body p-4">
                                        ...
                                        <div class="row g-4 mb-4">
                                            <div class="col-md-6">
                                                <label
                                                    class="form-label fw-bold text-muted small text-uppercase letter-spacing-1">UPC
                                                    <span class="text-danger">*</span></label>
                                                <div class="input-group shadow-sm rounded-3 overflow-hidden">
                                                    <span class="input-group-text bg-light border-0"><i
                                                            class="mdi mdi-barcode-scan"></i></span>
                                                    <input type="text" name="upc" id="upcInput"
                                                        class="form-control bg-light border-0 py-3 px-3 fs-6 font-monospace"
                                                        value="{{ $product->upc }}"
                                                        {{ !$product->store_id ? 'readonly' : '' }} required>
                                                    @if ($product->store_id)
                                                        <button type="button" id="generateUpcBtn"
                                        ...
                                        <div class="row g-4 mb-4">
                                            <div class="col-md-6">
                                                <label
                                                    class="form-label fw-bold text-muted small text-uppercase letter-spacing-1">Product
                                                    Name <span class="text-danger">*</span></label>
                                                <input type="text" name="product_name"
                                                    class="form-control bg-light border-0 shadow-sm py-3 px-3 fs-6 rounded-3"
                                        ...
                                        <div class="row g-4 mb-4">
                                            <div class="col-md-6">
                                                <label
                                                    class="form-label fw-bold text-muted small text-uppercase letter-spacing-1">Category
                                                    <span class="text-danger">*</span></label>
                                                <div class="shadow-sm rounded-3">
                                                    <select name="category_id" id="category_select"
                                                        class="form-select border-0 bg-light" required
                                                        {{ !$product->store_id ? 'disabled' : '' }}
                                                        style="width: 100%;">
                                            ...
                                            <div class="col-md-6">
                                                <label
                                                    class="form-label fw-bold text-muted small text-uppercase letter-spacing-1">Subcategory</label>
                                                <div class="shadow-sm rounded-3">
                                        ...
                                        <div class="mb-2">
                                            <label
                                                class="form-label fw-bold text-muted small text-uppercase letter-spacing-1">Description</label>
                                            <textarea name="description" class="form-control bg-light border-0 shadow-sm p-3 rounded-3" rows="4"
                                                {{ !$product->store_id ? 'readonly' : '' }}>{{ $product->description }}</textarea>
                                        </div>
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-12">
                                        <div class="card border-0 shadow-sm rounded-4">
                                            <div class="card-header bg-white border-bottom p-4">
                                                <h6 class="mb-0 fw-bold text-dark"><i
                                                        class="mdi mdi-cash-multiple text-success me-2"></i>Pricing &
                                                    Inventory</h6>
                                            </div>
                                            <div class="card-body p-4">
                                                <div class="mb-4">
                                                    <label
                                                        class="form-label fw-bold text-success small text-uppercase letter-spacing-1">Selling
                                                        Price ($) <span class="text-danger">*</span></label>
                                                    <div
                                                        class="input-group input-group-lg shadow-sm rounded-3 overflow-hidden">
                                                        <span
                                                            class="input-group-text bg-success bg-opacity-10 border-0 text-success fw-bold px-3">$</span>
                                                        <input type="number" step="0.01" name="selling_price"
                                                            class="form-control bg-light border-0 py-2 fs-5 fw-bold text-dark"
                                                            value="{{ $product->price }}" required>
                                                    </div>
                                                </div>
                                                <div class="mb-4">
                                                    <label
                                                        class="form-label fw-bold text-muted small text-uppercase letter-spacing-1">Unit
                                                        Type <span class="text-danger">*</span></label>
                                                    <select name="unit_type" id="unit_type_edit"
                                                        class="form-select bg-light border-0 shadow-sm py-2 px-3 rounded-3"
                                                        {{ !$product->store_id ? 'disabled' : '' }} required>
                                                        <option value="units"
                                                            {{ $product->unit_type == 'units' ? 'selected' : '' }}>
                                                            Units (pcs, boxes, etc.)</option>
                                                        <option value="weight"
                                                            {{ $product->unit_type == 'weight' ? 'selected' : '' }}>
                                                            Weight-based (lbs, kg)</option>
                                                    </select>
                                                </div>
                                                <div class="mb-4">
                                                    <label
                                                        class="form-label fw-bold text-muted small text-uppercase letter-spacing-1">Unit</label>
                                                    <input type="text" name="unit"
                                                        class="form-control bg-light border-0 shadow-sm py-2 px-3 rounded-3"
                                                        value="{{ $product->unit }}"
                                                        {{ !$product->store_id ? 'readonly' : '' }}>
                                                </div>
                                                <div class="mb-4" id="weight_options_edit_container"
                                                    style="display: {{ $product->unit_type == 'weight' ? 'block' : 'none' }};">
                                                    <label
                                                        class="form-label fw-bold text-muted small text-uppercase letter-spacing-1">Weight
                                                        Options (lbs)</label>
                                                    <input type="text" name="weight_options"
                                                        class="form-control bg-light border-0 shadow-sm py-2 px-3 rounded-3"
                                                        value="{{ is_array($product->weight_options) ? implode(',', $product->weight_options) : '' }}"
                                                ...
                                                <div class="mb-4">
                                                    <label
                                                        class="form-label fw-bold text-muted small text-uppercase letter-spacing-1">Lead
                                                        Time (Days)</label>
                                                    <input type="number" name="lead_time_days"
                                                        class="form-control bg-light border-0 shadow-sm py-2 px-3 rounded-3"
                                                        value="{{ $product->lead_time_days }}" min="0"
                                                        {{ !$product->store_id ? 'readonly' : '' }}>
                                                    <small class="text-muted">For international supply</small>
                                                </div>
                                                <div class="mb-2">
                                                    <div class="form-check">
                                                        <input type="checkbox" name="requires_expiration"
                                                            class="form-check-input" id="requires_expiration_edit"
                                                            value="1"
                                                            {{ $product->requires_expiration ? 'checked' : '' }}
                                                            {{ !$product->store_id ? 'disabled' : '' }}>
                                                        <label class="form-check-label fw-bold text-muted small"
                                                            for="requires_expiration_edit">
                                    ...
                                    @if ($product->store_id)
                                        <div class="col-12">
                                            <div class="card border-0 shadow-sm rounded-4">
                                                <div class="card-header bg-white border-bottom p-4">
                                                    <h6 class="mb-0 fw-bold text-dark"><i
                                                            class="mdi mdi-image-outline text-info me-2"></i>Product
                                                        Media</h6>
                                                </div>
                                                <div class="card-body p-4">
                                                    <label
                                                        class="form-label fw-bold text-muted small text-uppercase letter-spacing-1 mb-3">Update
                                                        Image</label>
                                                    ...
                                                    <div class="image-upload-wrapper mb-2 position-relative">
                                                        @if ($product->image)
                                                            ...
                                                            <div id="uploadPrompt" class="d-none">
                                                                <i
                                                                    class="mdi mdi-cloud-upload-outline display-4 text-muted opacity-50"></i>
                                                                <p class="text-muted small mt-2 mb-0">Click or drag
                                                                    image to update</p>
                                                            </div>
                                                        @else
                        ...
                        <div class="card border-0 shadow-sm rounded-4 mt-4">
                            <div class="card-body p-4 d-flex flex-column flex-sm-row justify-content-end gap-3">
                                <a href="{{ route('store.products.index') }}"
                                    class="btn btn-light border rounded-pill px-5 py-3 fw-bold shadow-sm order-2 order-sm-1 text-muted">
                                    Cancel
                                </a>
                                @if (Auth::user()->hasPermission('edit_product'))
                                    <button type="submit"
                                        class="btn btn-primary rounded-pill px-5 py-3 fw-bold shadow-sm order-1 order-sm-2 d-flex align-items-center justify-content-center">
                    ...
                    if (catId) {
                        fetch("{{ route('store.subcategories.get') }}", {
                            ...
                            .then(data => {
                                ...
                                if (data.length > 0) {
                                    data.forEach(sub => {
                                        var selected = (selectedSubId && sub.id == selectedSubId) ? true :
                                            false;
                            ...
                            .catch(error => {
                                ...
                                subSelect.empty().append('<option value="">Error fetching data</option>').trigger(
                                    'change');
                            });
                    } else {
