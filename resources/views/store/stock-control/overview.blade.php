                                    ...
                                    @forelse($topProductsByArea as $area => $data)
                                        <tr>
                                            ...
                                            <td class="px-3 py-2 small">
                                                {{ \Illuminate\Support\Str::limit($data->product_name, 20) }}</td>
                                            <td class="px-3 py-2 text-end">
                                                <span
                                                    class="badge bg-success small">{{ number_format($data->qty) }}</span>
                                            </td>
                                        </tr>
                                    @empty
                                        <tr>
                    ...
                    <table id="myStockTable" class="table table-hover align-middle mb-0" style="font-size: 0.9rem;">
                        <thead class="table-light">
                            <tr>
                                ...
                                <th class="px-3 py-3 fw-semibold">UPC</th>
                ...
                let table = $('#myStockTable').DataTable({
                    ...
                    columns: [{
                        ...
                        },
                        {
                            ...
                            className: 'px-3',
                            render: function(data) {
                                return '<code style="background: #f1f3f5; padding: 0.25rem 0.5rem; border-radius: 0.25rem; font-size: 0.85rem;">' +
                                    data + '</code>';
                            }
                        },
                        {
                            ...
                            className: 'px-3',
                            render: function(data) {
                                return '<span class="badge bg-primary-subtle text-primary" style="font-weight: 500;">' +
                                    data + '</span>';
                            }
                        },
                        {
                            ...
                            render: function(data) {
                                ...
                                return '<span class="badge bg-' + color +
                                    '" style="min-width: 50px; font-size: 0.85rem;">' + data +
                                    '</span>';
                            }
                        },
                        {
