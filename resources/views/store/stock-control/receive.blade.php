<x-app-layout title="Confirm Receipt">
    ...
    <div class="container-fluid">
        ...
        <form action="{{ route('store.stock-control.received.confirm', $request->id) }}" method="POST" id="receiveForm"
                                            ...
                                            <tr>
                                                <td class="ps-3">
                                                    <div class="fw-bold"><span
                                                            class="text-muted small">[{{ $item->product->upc ?? 'N/A' }}]</span>
                                                        {{ $item->product->product_name }}</div>
                                                    <small class="text-muted font-monospace">UPC:
                                                        {{ $item->product->upc ?? 'N/A' }} | Unit:
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <div class="badge bg-primary bg-opacity-10 text-primary small">
                                                        {{ $item->dispatched_quantity ?? $item->quantity }}</div>
                                                </td>
                                                <td>
                                                    <input type="number"
                                                ...
                                                <td>
                                                    <input type="text"
                                                        ...
                                                        placeholder="BATCH-{{ date('Ymd') }}" required>
                                                </td>
                                                <td>
                                                    <input type="date"
