    ...
    <div class="container-fluid">
        ...
        <div class="card border-0 shadow-sm mb-4 filter-card glass-effect" style="animation-delay: 0.1s">
            <div class="card-body p-4">
                <form action="{{ route('store.stock-control.valuation') }}" method="GET"
                    ...
                    <div class="card-body gradient-success p-4">
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                ...
                                <h1 class="fw-bold mb-0 text-white display-6">
                                    {{ number_format($topProducts->sum('quantity')) }}</h1>
                            </div>
                            <div class="bg-white bg-opacity-20 rounded-3 p-3 stat-icon">
                    ...
                    <div class="card-body gradient-info p-4">
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                ...
                                <h1 class="fw-bold mb-0 text-white display-6">
                                    ${{ number_format($topProducts->first()?->value ?? 0, 2) }}</h1>
                            </div>
                            <div class="bg-white bg-opacity-20 rounded-3 p-3 stat-icon">
                            ...
                            @forelse($topProducts as $index => $product)
                                <tr>
                                    <td class="text-center">
                                        <span
                                            class="rank-badge {{ $index < 3 ? 'rank-' . ($index + 1) : 'rank-default' }}">
                                            {{ $index + 1 }}
                                        </span>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <span
                                            class="badge bg-light text-dark border">{{ $product->upc ?? 'N/A' }}</span>
                                    </td>
                                    <td class="text-center">
                                    ...
                                    <td class="text-end">
                                        <a href="{{ route('store.products.analytics', $product->id) }}"
                                            class="btn btn-sm btn-info py-1 me-1" title="Analytics">
