            ...
            <div class="row justify-content-center">
                <div class="col-12 col-lg-8 col-xl-6">
                    ...
                    <div class="d-flex align-items-center mb-4">
                        ...
                        <div>
                            <h4 class="fw-bold mb-0 text-dark">Add New Subcategory</h4>
                            <p class="text-muted small mb-0 mt-1">Create a new local subcategory for your store</p>
                        </div>
                    </div>
                    ...
                    <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
                        <div class="card-header bg-white border-bottom p-4">
                            <div class="d-flex align-items-center">
                                <div class="bg-primary bg-opacity-10 rounded-circle d-flex align-items-center justify-content-center me-3" style="width: 40px; height: 40px;">
                                    <i class="mdi mdi-file-tree text-primary fs-5"></i>
                                </div>
                                <div>
                                    <h6 class="mb-0 fw-bold text-dark">Subcategory Details</h6>
                                    <small class="text-muted">Link this subcategory to an existing parent category.</small>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body p-4 p-md-5">
                            ...
                            <div class="alert alert-info bg-info bg-opacity-10 border-info border-opacity-25 text-info small rounded-3 mb-4 d-flex align-items-start">
                                ...
                                <div>Subcategories created here will be designated as <strong>Local (Store)</strong> subcategories and will not affect the global warehouse catalog.</div>
                            </div>
                            ...
                            <form class="forms-sample" action="{{ route('store.subcategories.store') }}" method="POST">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="input-group input-group-lg shadow-sm rounded-3 overflow-hidden">
                                        ...
                                        <input type="text" name="name" class="form-control bg-light border-start-0 py-2 fs-6" required placeholder="e.g. Smartphones, T-Shirts">
                                    </div>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="input-group input-group-lg shadow-sm rounded-3 overflow-hidden">
                                        ...
                                        <input type="text" name="code" class="form-control bg-light border-start-0 py-2 fs-6" required placeholder="e.g. SMRT-PHN, TSHRT-01">
                                    </div>
                                ...
                                <div class="d-flex justify-content-end gap-2 pt-4 mt-5 border-top">
                                    ...
                                    <button type="submit" class="btn btn-primary rounded-pill px-5 fw-bold shadow-sm d-flex align-items-center">
                                        <i class="mdi mdi-check-circle-outline me-2"></i> Save Subcategory
                                    </button>
                                </div>
                            </form>
                        </div>
