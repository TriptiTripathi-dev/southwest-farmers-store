                            ...
                            <div class="col-lg-7 p-4 p-md-5">
                                ...
                                <form method="POST" action="{{ route('website.register.post') }}"
                                    ...
                                    <div class="row g-2">
                                        ...
                                        <div class="col-md-3">
                                            <div class="field-group">
                                                <i class="mdi mdi-gender-male-female field-icon"></i>
                                                <select name="gender" class="custom-field @error('gender') is-invalid @enderror">
                                            ...
                                            @error('gender')<p class="invalid-note">{{ $message }}</p>@enderror
                                        </div>
                                        <div class="col-md-3">
                                            <div class="field-group">
                                                <i class="mdi mdi-calendar-outline field-icon"></i>
                                                <input type="date" name="date_of_birth"
                                                       class="custom-field @error('date_of_birth') is-invalid @enderror"
                                                       placeholder="Date of Birth"
                                                       value="{{ old('date_of_birth') }}"
                                                       max="{{ now()->subYears(10)->toDateString() }}">
                                            </div>
                                            @error('date_of_birth')<p class="invalid-note">{{ $message }}</p>@enderror
                                        </div>
                                    </div>
                                    ...
                                    <div class="row g-2">
                                        ...
                                        <div class="col-md-4">
                                            <div class="field-group">
                                                <i class="mdi mdi-city-variant-outline field-icon"></i>
                                                <input type="text" name="city"
                                                       class="custom-field @error('city') is-invalid @enderror"
                                                       placeholder="City"
                                                       value="{{ old('city') }}">
                                            </div>
                                            @error('city')<p class="invalid-note">{{ $message }}</p>@enderror
                                        </div>
                                        <div class="col-md-4">
                                            <div class="field-group">
                                                <i class="mdi mdi-map-outline field-icon"></i>
                                                <input type="text" name="state"
                                                       class="custom-field @error('state') is-invalid @enderror"
                                                       placeholder="State / Province"
                                                       value="{{ old('state') }}">
                                            </div>
                                            @error('state')<p class="invalid-note">{{ $message }}</p>@enderror
                                        </div>
                                        <div class="col-md-4">
                                            <div class="field-group">
                                                <i class="mdi mdi-mailbox-outline field-icon"></i>
                                                <input type="text" name="zip_code"
                                                       class="custom-field @error('zip_code') is-invalid @enderror"
                                                       placeholder="ZIP / PIN Code"
                                                       value="{{ old('zip_code') }}">
                                            </div>
                                            @error('zip_code')<p class="invalid-note">{{ $message }}</p>@enderror
                                        </div>
                                        <div class="col-md-6">
                                            <div class="field-group">
                                                <i class="mdi mdi-earth field-icon"></i>
                                                <input type="text" name="country"
                                                       class="custom-field @error('country') is-invalid @enderror"
                                                       placeholder="Country"
                                                       value="{{ old('country', 'India') }}">
                                            </div>
                                            @error('country')<p class="invalid-note">{{ $message }}</p>@enderror
                                        </div>
                                    </div>
